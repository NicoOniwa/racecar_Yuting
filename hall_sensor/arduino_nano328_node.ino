...
class Car {
  ...
  private:
    ...
    volatile uint16_t FL_count_shared = 0;
    volatile uint16_t FR_count_shared = 0;
    volatile uint16_t BL_count_shared = 0;
    volatile uint16_t BR_count_shared = 0;
    uint16_t FL_count = 0;
    uint16_t FR_count = 0;
    uint16_t BL_count = 0;
    uint16_t BR_count = 0;
    uint16_t FL_count_old = 0;
    uint16_t FR_count_old = 0;
    uint16_t BL_count_old = 0;
    uint16_t BR_count_old = 0;
    float vel_FL = 0;
    float vel_FR = 0;
    float vel_BL = 0;
    float vel_BR = 0;
